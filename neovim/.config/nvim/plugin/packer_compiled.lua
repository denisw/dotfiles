...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/vim-vsnip",
  ...
  ["zen-mode.nvim"] = {
    ...
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
